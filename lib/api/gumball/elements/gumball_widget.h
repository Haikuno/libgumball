...
/*! \name Runtime state
 *  @{ */
GBL_EXPORT GblBool       GUM_Widget_isActive  (const GUM_Widget* pSelf) GBL_NOEXCEPT; //!< Returns true if this Widget is active.
GBL_EXPORT GblBool       GUM_Widget_isFocused (const GUM_Widget* pSelf) GBL_NOEXCEPT; //!< Returns true if this Widget is focused by any input device.
GBL_EXPORT uint8_t       GUM_Widget_zIndex    (const GUM_Widget* pSelf) GBL_NOEXCEPT; //!< Returns this Widget's z-index.
GBL_EXPORT GblStringRef* GUM_Widget_label     (const GUM_Widget* pSelf) GBL_NOEXCEPT; //!< Returns this Widget's label. Do not unref it.
GBL_EXPORT GUM_Font*     GUM_Widget_font      (const GUM_Widget* pSelf) GBL_NOEXCEPT; //!< Returns this Widget's font. Do not unref it.
GBL_EXPORT GUM_Texture*  GUM_Widget_texture   (const GUM_Widget* pSelf) GBL_NOEXCEPT; //!< Returns this Widget's texture. Do not unref it.
//! @}
