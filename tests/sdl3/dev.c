...
int main(int argc, char* argv[]) {
    ...
    GUM_Container* pContainer = GUM_Container_create("x", 40.0f, "y", 40.0f,
                                                     "w", 720.0f, "h", 520.0f,
                                                     "padding", 12.0f,
                                                     "margin", 12.0f);
    GUM_Widget_create("parent", pContainer, "color", 0x7C3AEDFF);
    GUM_Widget_create("parent", pContainer, "color", 0x18B7A5FF);
